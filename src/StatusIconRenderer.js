import { logger, loadFile, padZero } from 'src/Utils';
import { SpriteTexture } from 'src/Texture';
...
export class StatusIconRenderer {
    constructor() {
        this.shader = null;
        this.buffer = null;
        this.sprite = null;
    ...
    spriteId(name, frame) {
        var tex = 'as_' + name + '/idle/45/' + padZero(frame, 3) + '.png';
